...
use Phinance\Http\HttpPostRequest;
...
class PhinanceClient implements IPhinanceClient
{
     ...
     * @throws ApiClientException
     */
    private function privatePost($api, $security_type, $post_data = null, $return_value = true)
    {
        ...
        $request = new HttpPostRequest($this, $url, array(), $options);
